...
void dynamic_check()
{
				...
				if(max_dynamic > 5 && TIM4->CNT > 25000) //|| AddWaterTime > 50000 3.20¸Ä ÔÚTIM4->CNT <= 10000ÄÚÆÁ±Î¹ØË® 5.22 TIM4->CNT > 25000 µ÷ÊÔ
				{
...
void dynamic_check_Glass(){
				...
				if(max_dynamic > 5 && TIM4->CNT > 10000) 	//5.11¸Ä ÔÚTIM4->CNT <= 10000ÄÚÆÁ±Î¹ØË® 5.22 
				{
					static_flag2 = -1;				//Çå³ý¾²Ì¬¼ÓË®ÖÐµÄ»º´æ
					static_flag1 = -1;
					On_Off = 0;//¹Ø¶Ï¼ÓË®ÐÅºÅ
